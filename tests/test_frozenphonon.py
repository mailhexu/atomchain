...
Purpose:
    ...
    and ML potential calculators (CHGNet, etc.)
...
def test_calculate_phonon_al_basic(al_structure, chgnet_calculator, temp_dir):
    """
...
def test_calculate_phonon_srtio3_basic(srtio3_structure, chgnet_calculator, temp_dir):
    """
...
def test_calculate_phonon_with_restart(al_structure, chgnet_calculator, temp_dir):
    """
...
def test_compute_phonon_at_qpoints(al_structure, chgnet_calculator, temp_dir):
    """
    ...
    try:
        ...
        assert result['eigenvectors'].shape == (1, result['nbands'], len(al_structure), 3)
...
def test_compute_phonon_at_multiple_qpoints(al_structure, chgnet_calculator, temp_dir):
    """
    ...
    try:
        ...
        assert result['eigenvectors'].shape == (3, result['nbands'], len(al_structure), 3)
